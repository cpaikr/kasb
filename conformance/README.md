...
and Rust SDKs. `v1/cases.json` declares serialized inputs, fixture-backed source
routes, and committed expected outcomes. It contains no imports from either SDK.
