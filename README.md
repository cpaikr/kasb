...
Command success emits one JSON envelope to stdout. Command failure emits one JSON envelope to stderr with a nonzero exit code and empty stdout. Help output remains human-readable.
