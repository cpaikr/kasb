...
switch ("$Platform`:$Architecture") {
  "Unix:Linux:X64" { $Target = "linux-x64-gnu"; $Archive = "kasb-0.4.3-linux-x64-gnu.tar.gz"; $Executable = "kasb"; $ArchiveEntries = @('kasb', 'LICENSE.md', 'README.md', 'THIRD_PARTY_LICENSES.html') }
  "Unix:Linux:Arm64" { $Target = "linux-arm64-gnu"; $Archive = "kasb-0.4.3-linux-arm64-gnu.tar.gz"; $Executable = "kasb"; $ArchiveEntries = @('kasb', 'LICENSE.md', 'README.md', 'THIRD_PARTY_LICENSES.html') }
  "Unix:OSX:Arm64" { $Target = "darwin-arm64"; $Archive = "kasb-0.4.3-darwin-arm64.tar.gz"; $Executable = "kasb"; $ArchiveEntries = @('kasb', 'LICENSE.md', 'README.md', 'THIRD_PARTY_LICENSES.html') }
  "Win32NT:X64" { $Target = "win32-x64-msvc"; $Archive = "kasb-0.4.3-win32-x64-msvc.tar.gz"; $Executable = "kasb.exe"; $ArchiveEntries = @('kasb.exe', 'LICENSE.md', 'README.md', 'THIRD_PARTY_LICENSES.html') }
