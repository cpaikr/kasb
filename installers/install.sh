...
case "${os}:${arch}" in
  Linux:x86_64) target='linux-x64-gnu'; archive='kasb-0.3.2-linux-x64-gnu.tar.gz'; executable='kasb' ;;
  Linux:arm64|Linux:aarch64) target='linux-arm64-gnu'; archive='kasb-0.3.2-linux-arm64-gnu.tar.gz'; executable='kasb' ;;
  Darwin:arm64|Darwin:aarch64) target='darwin-arm64'; archive='kasb-0.3.2-darwin-arm64.tar.gz'; executable='kasb' ;;
